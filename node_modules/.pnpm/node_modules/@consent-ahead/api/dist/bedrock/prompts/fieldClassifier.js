...
exports.FIELD_CLASSIFIER_SYSTEM_PROMPT = void 0;
exports.buildFieldClassifierPrompt = buildFieldClassifierPrompt;
exports.buildFieldClassificationPrompt = buildFieldClassificationPrompt;
exports.FIELD_CLASSIFIER_SYSTEM_PROMPT = `
...
- unknown: Cannot determine
`.trim();
function buildFieldClassifierPrompt(fields) {
    return buildFieldClassificationPrompt(fields);
}
function buildFieldClassificationPrompt(fields) {
...
//# sourceMappingURL=fieldClassifier.js.map