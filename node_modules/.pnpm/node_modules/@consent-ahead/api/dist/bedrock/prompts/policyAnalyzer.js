...
exports.POLICY_ANALYZER_SYSTEM_PROMPT = void 0;
exports.buildPolicyAnalyzerPrompt = buildPolicyAnalyzerPrompt;
exports.buildPolicyAnalysisPrompt = buildPolicyAnalysisPrompt;
exports.POLICY_ANALYZER_SYSTEM_PROMPT = `
...
`.trim();
function buildPolicyAnalyzerPrompt(domain, policyText, targetCategories = []) {
...
function buildPolicyAnalysisPrompt(requestedFields, policyChunks, domain) {
...
//# sourceMappingURL=policyAnalyzer.js.map